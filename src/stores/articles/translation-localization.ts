...
export default <IArticle>{
    ...
    id: 'language-power',
    introduction: {
        preview: "Localization and translation are standard for global products. This post explores power dynamics between languages that translators should be mindful of.",
